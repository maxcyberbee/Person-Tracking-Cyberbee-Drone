...
def draw_skeleton(
    ...
    out_img = cv2.circle(out_img, (out_img.shape[0],out_image.shape[1]-10), 5, (255, 0, 0) , 2)
    return out_img
...
def draw_skel_and_kp(
    ...
    out_img = cv2.polylines(out_img, adjacent_keypoints, isClosed=False, color=(255, 255, 0))
    out_img = cv2.circle(out_img, (int(out_img.shape[1]/2),int(out_img.shape[0]/2)-10), 5, (255, 0, 0) , 1)
    return out_img
